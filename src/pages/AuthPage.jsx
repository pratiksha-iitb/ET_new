...
export default function AuthPage({ onAuth }) {
  ...
  // 🔥 NEW: AUTO LOGIN FROM MERGE
  useEffect(() => {
    const token = sessionStorage.getItem("token");
    const mergeStudentId = sessionStorage.getItem("student_id");

    if (token && mergeStudentId) {
      console.log("Merge login detected");

      // You can assign default name
      const studentName = mergeStudentId;

      sessionStorage.setItem("its_student_id", mergeStudentId);
      sessionStorage.setItem("its_student_name", studentName);

      onAuth({
        studentId: mergeStudentId,
